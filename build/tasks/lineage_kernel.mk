...
#
#   TARGET_KERNEL_SDCLANG_COMPILE      = Compile kernel with sdclang, defaults to true
#
...
#   TARGET_KERNEL_ADDITIONAL_DEPS      = Optional, additional dependencies for
#										   kernel image build
...
ifneq ($(TARGET_KERNEL_CLANG_COMPILE),false)
	ifneq ($(TARGET_KERNEL_SDCLANG_COMPILE), false)
        ...
        ifeq ($(KERNEL_ARCH),arm64)
            ...
            KERNEL_CLANG_TRIPLE ?= CLANG_TRIPLE=arm-linux-gnueabihf
        endif	
    else
...
$(KERNEL_HEADERS_INSTALL): $(DTC) $(DEPMOD) | $(KERNEL_CONFIG)
    # Somewhy it doesn't work with $(call make-kernel-target)
	$(PATH_OVERRIDE) $(KERNEL_MAKE_CMD) $(KERNEL_MAKE_FLAGS) -C $(KERNEL_SRC) O=$(KERNEL_BUILD_OUT_PREFIX)$(KERNEL_OUT) ARCH=$(KERNEL_ARCH) $(KERNEL_CROSS_COMPILE) $(KERNEL_CLANG_TRIPLE) $(KERNEL_CC) $(KERNEL_LD) headers_install
...
$(KERNEL_USR): | $(KERNEL_HEADERS_INSTALL)
	...
	ln -s kernel/$(TARGET_KERNEL_VERSION) $(KERNEL_SYMLINK); \
	fi
...
$(TARGET_PREBUILT_INT_KERNEL): $(KERNEL_USR) $(DEPMOD) $(DTC) $(TARGET_KERNEL_ADDITIONAL_DEPS)
...
$(BOARD_PREBUILT_DTBOIMAGE): $(DTC) $(MKDTIMG) $(MKDTBOIMG) $(TARGET_KERNEL_ADDITIONAL_DEPS)
...
$(INSTALLED_DTBIMAGE_TARGET): $(DTC) $(TARGET_KERNEL_ADDITIONAL_DEPS)
