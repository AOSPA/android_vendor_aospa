...
PRODUCT_COPY_FILES += \
    ...
    vendor/aospa/target/config/permissions/default_permissions_co.aospa.sense.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/default-permissions/default_permissions_co.aospa.sense.xml \
