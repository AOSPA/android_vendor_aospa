...
# AOSPA Version
ifneq ($(filter release,$(AOSPA_BUILD_VARIANT)),)
  AOSPA_VERSION := $(AOSPA_MAJOR_VERSION)-$(AOSPA_MINOR_VERSION)-$(AOSPA_BUILD)-$(BUILD_DATE)
else ifneq ($(filter unofficial,$(AOSPA_BUILD_VARIANT)),)
  AOSPA_VERSION := $(AOSPA_MAJOR_VERSION)-$(AOSPA_BUILD_VARIANT)-$(AOSPA_BUILD)-$(BUILD_DATE)
else
  AOSPA_VERSION := $(AOSPA_MAJOR_VERSION)-$(AOSPA_BUILD_VARIANT)-$(AOSPA_MINOR_VERSION)-$(AOSPA_BUILD)-$(BUILD_DATE)
endif
