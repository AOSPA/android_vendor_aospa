...
ifneq ($(filter release,$(AOSPA_BUILD_VARIANT)),)
  PA_VERSION := $(AOSPA_MAJOR_VERSION)-$(AOSPA_MINOR_VERSION)-$(PA_BUILD)-$(BUILD_DATE)
else
  PA_VERSION := $(AOSPA_MAJOR_VERSION)-$(AOSPA_BUILD_VARIANT)-$(AOSPA_MINOR_VERSION)-$(AOSPA_BUILD)-$(BUILD_DATE)
endif
