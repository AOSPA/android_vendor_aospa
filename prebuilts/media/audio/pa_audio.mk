...
ALARM_PATH := vendor/aospa/prebuilts/media/audio/alarms
NOTIFICATION_PATH := vendor/aospa/prebuilts/media/audio/notifications
RINGTONE_PATH := vendor/aospa/prebuilts/media/audio/ringtones
